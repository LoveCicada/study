 /*
 * Filename: SBT_TransBaseDefine.h
 * Contents: Base defination for file and media transcode SDK 
 * Author: Qiaohai Pan, 
 * Date: July, 11, 2003 
 * Revised: Aug, 19, 2003  
 * Version 1.0.0 
 * All Rights Reserved
 * Sobey Media Process & Analysis Group
 * Attention: Maybe subject to change without notification!
*/ 

#ifndef XH_TRANSCODE_BASE_MEDIA_FILE_FORMAT_MPAG
#define XH_TRANSCODE_BASE_MEDIA_FILE_FORMAT_MPAG
...
#define XH_TRANS_PLUGIN_FILE_SSEQ			0x4668E71C

#define XH_TRANS_PLUGIN_FILE_4IN1			0x46057484

#define XH_TRANS_PLUGIN_FILE_SEFS			0x4670F39C
...
//Plugin CineForm HD
#define XH_TRANS_PLUGIN_VIDEO_CINEFORM		0x563513CC
//Plugin VP6 Flv
#define XH_TRANS_PLUGIN_VIDEO_VP6F	        0x563C665F
//Plugin VP9
#define XH_TRANS_PLUGIN_VIDEO_VP9			0x56FC965F

//Plugin 4 x XAVC
#define XH_TRANS_PLUGIN_VIDEO_4_XAVC		0x5631F844

//Sobey UHDCodec
#define XH_TRANS_PLUGIN_VIDEO_UHDC			0x5630D45E

//Sobey ScalableCodec
#define XH_TRANS_PLUGIN_VIDEO_SSVC			0x5631F71C	

//Plugin JpegXS
#define XH_TRANS_PLUGIN_VIDEO_JpegXS		0x56721653

//Plugin SVES
#define XH_TRANS_PLUGIN_VIDEO_SEVC			0x5631F39C
